...
public class BoxBean {
     ...
     * <p>
     * This method uses bean-managed transactions.
     * </p>
     *
     * @return the result
     */
    public String createCentralBox() {
        ...
        try {
            ...
            if (getNumberOfCentralBoxes() > 3) {
                ...
                final String msg = "The maximum number of boxes is 3. " +
                                   "The creation was aborted and the transaction was marked for rollback.";
                report.add(msg);
    ...
    /**
     * Clears the multiplicity before removal.
     *
     * @param centralBox the {@link CentralBox}
     */
    ...
    /**
     * Gets the number of {@link CentralBox} instances.
     *
     * @return the number
     */
